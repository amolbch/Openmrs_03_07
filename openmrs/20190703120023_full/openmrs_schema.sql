...
DROP TABLE IF EXISTS `allergy_New`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `allergy_New` (
  `allergy_id` int(11) NOT NULL AUTO_INCREMENT,
  `previous_allergy_id` int(11) DEFAULT NULL,
  `patient_id` int(11) NOT NULL,
  `status` varchar(255) NOT NULL,
  `concept_id` int(11) NOT NULL,
  `allergy_non_coded` varchar(1024) DEFAULT NULL,
  ...
  UNIQUE KEY `allergy_uuid_index` (`uuid`),
  KEY `allergies_previous_allergy_id_fk` (`previous_allergy_id`),
  KEY `allergies_patient_fk` (`patient_id`),
  KEY `allergies_concept_fk` (`concept_id`),
  KEY `allergies_end_reason_fk` (`end_reason`),
  KEY `allergies_created_by_fk` (`creator`),
  KEY `allergies_voided_by_fk` (`voided_by`),
  CONSTRAINT `allergies_concept_fk` FOREIGN KEY (`concept_id`) REFERENCES `concept` (`concept_id`),
  CONSTRAINT `allergies_created_by_fk` FOREIGN KEY (`creator`) REFERENCES `users` (`user_id`),
  CONSTRAINT `allergies_end_reason_fk` FOREIGN KEY (`end_reason`) REFERENCES `concept` (`concept_id`),
  CONSTRAINT `allergies_patient_fk` FOREIGN KEY (`patient_id`) REFERENCES `patient` (`patient_id`) ON UPDATE CASCADE,
  CONSTRAINT `allergies_previous_allergy_id_fk` FOREIGN KEY (`previous_allergy_id`) REFERENCES `allergy_New` (`allergy_id`),
  CONSTRAINT `allergies_voided_by_fk` FOREIGN KEY (`voided_by`) REFERENCES `users` (`user_id`)
...
) ENGINE=InnoDB AUTO_INCREMENT=12497 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=11260 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-07-03 12:00:37
